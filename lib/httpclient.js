...
const INDEPENDENT_EXECUTION = global.ASB_CONSTANTS?.ESBCONF == undefined;    // support independent execution
let ASB_CONSTANTS, LOG;
if (INDEPENDENT_EXECUTION) {
    ASB_CONSTANTS = {LIBDIR: __dirname};
    LOG = {info: s => console.info(s), error: s => console.error(s), warn: s => console.warn(s)};
} else {ASB_CONSTANTS = global.ASB_CONSTANTS; LOG = global.LOG;}
