...
Logger.prototype.info = function(s, sync) {if (!log_conf.disabled) this.writeFile("info", s, sync);}

Logger.prototype.debug = function(s, sync) {if (!log_conf.disabled && log_conf.debug) this.writeFile("debug", s, sync);}

Logger.prototype.error = function(s, sync) {if (!log_conf.disabled)this.writeFile("error", s, sync);}
