...
const fs = require("fs");
const Timer = require(`${ASB_CONSTANTS.LIBDIR}/Timer.js`);
...
exports.createFileWriter = (path, writeCloseTimeout, encoding, overwrite) => {
    return new FastFileWriter(path, writeCloseTimeout, encoding, overwrite);
}