 ...
 */
 if (!global.ASB_CONSTANTS) global.ASB_CONSTANTS = require(__dirname + "/constants.js");	// to support direct execution

 const httpClient = require(ASB_CONSTANTS.LIBDIR + "/httpclient.js");
 
 async function post(host, port, path, headers, req, timeout, callback) {
     const jsonStr = typeof (req) == "object" ? JSON.stringify(req) : req; headers = _getRESTHeaders(headers);
     try {
         const result = await httpClient.post(host, port, path, headers, jsonStr, timeout); 
 ...
 async function postHttps(host, port, path, headers, req, timeout, sslObj, callback) {
     const jsonStr = typeof (req) == "object" ? JSON.stringify(req) : req; headers = _getRESTHeaders(headers);
     try {
         const result = await httpClient.postHttps(host, port, path, headers, jsonStr, timeout, sslObj); 
         if (result.data) result.data = JSON.parse(result.data); if (callback) callback(null, result); else return result;
     } catch (err) { if (callback) callback(err); else throw err; }
 }
 
 async function put(host, port, path, headers, req, timeout, callback) {
     const jsonStr = typeof (req) == "object" ? JSON.stringify(req) : req; headers = _getRESTHeaders(headers);
     try {
         const result = await httpClient.put(host, port, path, headers, jsonStr, timeout); 
         if (result.data) result.data = JSON.parse(result.data); if (callback) callback(null, result); else return result;
     } catch (err) { if (callback) callback(err); else throw err; }
 }
 
 async function putHttps(host, port, path, headers, req, timeout, sslObj, callback) {
     const jsonStr = typeof (req) == "object" ? JSON.stringify(req) : req;  headers = _getRESTHeaders(headers);
     try {
         const result = await httpClient.putHttps(host, port, path, headers, jsonStr, timeout, sslObj); 
         if (result.data) result.data = JSON.parse(result.data); if (callback) callback(null, result); else return result;
     } catch (err) { if (callback) callback(err); else throw err; }
 }
 
 async function get(host, port, path, headers, req, timeout, callback) {
     try {
         const result = await httpClient.get(host, port, path, headers, req, timeout); 
         if (result.data) result.data = JSON.parse(result.data); if (callback) callback(null, result); else return result;
     } catch (err) { if (callback) callback(err); else throw err; }
 }
 
 async function getHttps(host, port, path, headers, req, timeout, sslObj, callback) {
     try {
         const result = await httpClient.getHttps(host, port, path, headers, req, timeout, sslObj); 
         if (result.data) result.data = JSON.parse(result.data); if (callback) callback(null, result); else return result;
     } catch (err) { if (callback) callback(err); else throw err; }
 }
 
 async function deleteHttp(host, port, path, headers, _req, timeout, callback) {
     try {
         const result = await httpClient.deleteHttp(host, port, path, headers, _req, timeout); 
         if (result.data) result.data = JSON.parse(result.data); if (callback) callback(null, result); else return result;
     } catch (err) { if (callback) callback(err); else throw err; }
 }
 
 async function deleteHttps(host, port, path, headers, _req, timeout, sslObj, callback) {
     try {
         const result = await httpClient.deleteHttps(host, port, path, headers, _req, timeout, sslObj); 
         if (result.data) result.data = JSON.parse(result.data); if (callback) callback(null, result); else return result;
     } catch (err) { if (callback) callback(err); else throw err; }
 }
