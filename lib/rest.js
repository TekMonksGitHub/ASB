 ...
 */
 ...
 async function post(host, port, path, headers, req, timeout, sslObj, callback) {
 ...
 async function put(host, port, path, headers, req, timeout, sslObj, callback) {
     const jsonStr = typeof (req) == "object" ? JSON.stringify(req) : req; headers = _getRESTHeaders(headers);
     try {
 ...
 async function get(host, port, path, headers, req, timeout, sslObj, callback) {
     try {
 ...
 async function deleteHttp(host, port, path, headers, _req, timeout, sslObj, callback) {
     try {
