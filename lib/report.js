...
const getTestDescription = (filename) => {
    const descriptions = {
        "test_CSVtojson.js": "Convert CSV Files to JSON Format Efficiently",
        "test_RESThello.js": "Send Personalized Greetings via /hello API",
        "test_RESTtoCSV.js": "Convert API Data to CSV and Respond via /tocsv",
        "test_jsontoXMLViaMustache.js": "Convert JSON to XML Using Mustache Templates"
    };
...
exports.initiateReport = function() {
    return new Promise((resolve, reject) => {
        ...
        const reportsDir = path.join(CONSTANTS.ROOTDIR, 'reports');
...
exports.updateReport = function(reportName,filename,result,message,startTime,endTime){
	...
	const filePath = path.join(CONSTANTS.ROOTDIR, 'reports', reportName);
    ...
    const data = fs.readFileSync(filePath, 'utf8')
        ...
        const testResult = {
            name: getTestDescription(filename),
            status: result,
